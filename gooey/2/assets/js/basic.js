...
function moveHandler(e) {
  ...
  water.setAttribute(
    "d",
    `M0,0 
    C${mouse.x - dropRadius},0 ${mouse.x - dropRadius},${mouse.y} ${mouse.x},${
      mouse.y
    } 
    C${mouse.x + dropRadius},${mouse.y} ${mouse.x + dropRadius},0 ${
      body.offsetWidth
    },0 
    T0,0`
  );
...
function leaveHandler() {
  water.setAttribute(
    "d",
    `M0,0 Q${body.offsetWidth / 2},${body.offsetHeight / 5} ${
      body.offsetWidth
    },0`
  );
}
